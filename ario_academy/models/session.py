...
class Session(models.Model):
    _name ='ario_academy.session'
    _description = 'ario_academy_session'

    name = fields.Char(string='Name',required=True, index=True)
    course_id = fields.Many2one(comodel_name='ario_academy.course', string='Course')
    # user_id = fields.Many2one(comodel_name='res.users', string='Instructor',domain="[('is_instructor','=',True)]")
    ...
    taken_seats = fields.Float('Taken Seats',compute='_count_taken_seats',store=True)
